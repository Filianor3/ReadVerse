...
public class ReviewDAOTest extends TestCase {
    ...
    public void testGetUsersReviews() throws SQLException {
        ReviewDAO rd = new DbReviewDAO(true);
        // Prepare test data
        List<Integer> userIDs = List.of(1, 2, 3);
        // Call the method to test
        List<Review> actualReviews = rd.getUsersReviews(userIDs);
        // Assert the size of the actual reviews list
        assertEquals(15, actualReviews.size()); // Adjust the expected size accordingly
